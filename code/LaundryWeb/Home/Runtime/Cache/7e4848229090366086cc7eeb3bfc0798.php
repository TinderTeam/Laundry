...
<head>
    ...
    <link rel="stylesheet" href="__PUBLIC__/ThirdParty/chahua/plugins/bootstrap/css/bootstrap.min.css" />
    <link rel="stylesheet" href="__PUBLIC__/ThirdParty/chahua/css/style.css" />
    <link rel="stylesheet" href="__PUBLIC__/ThirdParty/chahua/css/headers/header1.css" />
    <link rel="stylesheet" href="__PUBLIC__/ThirdParty/chahua/plugins/bootstrap/css/bootstrap-responsive.min.css" />
    <link rel="stylesheet" href="__PUBLIC__/ThirdParty/chahua/css/style_responsive.css" />
    <link rel="shortcut icon" href="favicon.ico" />        
    <!-- CSS Implementing Plugins -->    
    <link rel="stylesheet" href="__PUBLIC__/ThirdParty/chahua/plugins/font-awesome/css/font-awesome.css" />
    <link rel="stylesheet" href="__PUBLIC__/ThirdParty/chahua/plugins/flexslider/flexslider.css" type="text/css" media="screen" />    	
    <link rel="stylesheet" href="__PUBLIC__/ThirdParty/chahua/plugins/parallax-slider/css/parallax-slider.css" type="text/css" />
    <!-- CSS Theme -->    
    <link rel="stylesheet" href="__PUBLIC__/ThirdParty/chahua/css/themes/default.css" id="style_color" />
...
<div class="header" style="margin-top:20px;">               
    <div class="container"> 
        <!-- Logo -->       
        <div class="logo">                                             
            <a href="index.html"><img id="logo-header" src="img/logo.png" alt="Quik" /></a>
        </div><!-- /logo -->        
...
<div id="myCarousel" class="carousel slide"  >
  ...
  <div class="carousel-inner">
    <div class="active item"><img src="img/AD1.jpg" alt="" /></div>
    <div class="item"><img src="img/AD2.jpg" alt="" /></div>
    <div class="item"><img src="img/AD3.jpg" alt="" /></div>
  </div>
  <!-- Carousel nav -->
...
<script type="text/javascript" src="__PUBLIC__/ThirdParty/chahua/js/jquery-1.8.2.min.js"></script>
<script type="text/javascript" src="__PUBLIC__/ThirdParty/chahua/js/modernizr.custom.js"></script>		
<script type="text/javascript" src="__PUBLIC__/ThirdParty/chahua/plugins/bootstrap/js/bootstrap.min.js"></script>	
<!-- JS Implementing Plugins -->           
<script type="text/javascript" src="__PUBLIC__/ThirdParty/chahua/plugins/flexslider/jquery.flexslider-min.js"></script>
<script type="text/javascript" src="__PUBLIC__/ThirdParty/chahua/plugins/parallax-slider/js/modernizr.js"></script>
<script type="text/javascript" src="__PUBLIC__/ThirdParty/chahua/plugins/parallax-slider/js/jquery.cslider.js"></script> 
<script type="text/javascript" src="__PUBLIC__/ThirdParty/chahua/plugins/back-to-top.js"></script>
<!-- JS Page Level -->           
<script type="text/javascript" src="__PUBLIC__/ThirdParty/chahua/js/app.js"></script>
<script type="text/javascript" src="__PUBLIC__/ThirdParty/chahua/js/pages/index.js"></script>
<script type="text/javascript">
