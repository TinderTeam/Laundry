	...
	class SmartTemplate
	{
		...
		*/
		function output ( $_top = '' )
		{
			...
			if (strlen($cpl_file_name) > 0)
			{
				...
				if ($compile_template)
				{
					if (@include_once("../../ThirdParty/ThinkPHP/Extend/Vendor/SmartTemplate/class.smarttemplateparser.php"))
					{
		...
		*/
		function debug ( $_top = '' )
		{
			...
			if (@include_once("../../ThirdParty/ThinkPHP/Extend/Vendor/SmartTemplate/class.smarttemplatedebugger.php"))
			{
