...
<body>
	...
	<table class="easyui-datagrid" title="Basic DataGrid" style="width:100%;height:100%"
			data-options="pagination:true,pageList:[10,20,30],singleSelect:true,collapsible:true,url:'__APP__/UserManage/LoadPage',method:'POST'">
		<thead>
			<tr>
				<th data-options="field:'user_id',width:80">Item ID</th>
			</tr>
		</thead>
	</table>
